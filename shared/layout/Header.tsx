...
import ButtonOutline from "../../shared/atoms/ButtonOutline";
import Image from "next/image";

import Link from "next/link";
import LanguageSwitcher from "@/shared/layout/LanguageSwitcher";
import { HeaderType } from "../types/HeaderType";
import Loqo from "../components/Loqo";

interface HeadedrProps {
  t: HeaderType;
}
export default function Header({ t }: HeadedrProps) {
      ...
      >
        <nav className="max-w-screen-xl px-6 sm:px-8 lg:px-16 mx-auto grid grid-flow-col py-3 sm:py-4">
          ...
          <div className="col-start-10 col-end-12 font-medium flex justify-between items-center">
            <LanguageSwitcher t={{ az: "Az", en: "En", ru: "Ru" }} />
