...
import { TestimonialType } from "@/shared/types/TestimonialType";
...
const Testimonial = ({ t }: TestimonialProp) => {
  ...
  const settings = {
    ...
    dotsClass:
      "slick-dots  mt-20 absolute top-[29.5rem] lg:top-[30rem] right-0 left-0",
    infinite: true,
    speed: 500,
    slidesToShow: 3,
    slidesToScroll: 2,
                  ...
                  listTestimonial?.map((listTestimonis, index) => {
                    return (
                      <div className="px-3 flex items-stretch " key={index}>
                        <div className="border-2 h-[460px] lg:h-[450px]  overflow-y-auto border-gray-500 hover:border-orange-500 transition-all rounded-lg p-8 flex flex-col">
                          ...
                          <p className="mt-5 text-left">
                            {listTestimonis?.testimonial[currentLang]}
                          </p>
                        </div>
                      </div>
                    );
